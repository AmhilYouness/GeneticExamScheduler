...
def generate_population(population_size, courses, teachers, total_days):
    new_pop = []

    for i in range(0, population_size):
        schedule = Schedule(dict(), total_days=total_days)
...
def genetic_algo(population_size, max_generations, crossover_probability, mutation_probability, courses, teachers,
    ...
    population = [generate_population(population_size, courses, teachers, total_days)]
    ...
    for i in range(max_generations):
        ...
        if stagnant == 50:
            if reset_count < 3:
                ...
                pop = generate_population(population_size, courses, teachers, total_days)
                best_solution = None
                population.clear()
